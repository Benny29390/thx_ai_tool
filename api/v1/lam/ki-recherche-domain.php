<?php
/** POST /lam/ki-recherche-domain Body: { domain_id } */
...
try { Response::success($svc->kiRecherchierDomain($id)); }
catch (\InvalidArgumentException $e) { Response::error($e->getMessage(), 400); }
catch (\Throwable $e) { Response::error('KI-Recherche fehlgeschlagen: ' . $e->getMessage(), 500); }
