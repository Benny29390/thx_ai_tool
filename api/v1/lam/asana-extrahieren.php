<?php
/** POST /lam/asana-extrahieren Body: { massnahme_id } */
...
try { Response::success($svc->asanaExtrahiereFelder($id)); }
catch (\InvalidArgumentException $e) { Response::error($e->getMessage(), 400); }
catch (\Throwable $e) { Response::error('Extraktion fehlgeschlagen: ' . $e->getMessage(), 500); }
