<?php
/** POST /lam/linkoption-asana-verknuepfen Body: { linkoption_id, task_gid_oder_url } */
...
if ($id === '' || $eingabe === '') Response::error('linkoption_id + task_gid_oder_url erforderlich', 400);
...
try { Response::success($svc->asanaVerknuepfeLinkoption($id, $gid)); }
